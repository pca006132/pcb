    ...
    public class PcbParser
    {
        ...
        private string[] pcb2Command(string pcb, AbstractCBChain chain)
        {
            ...
            foreach (string rawLine in lines)
            {
                ...
                //active`s sugar
                line = line.Replace("active:this", "blockdata ~ ~ ~ {auto:1b}");
                line = line.Replace("close:this", "blockdata ~ ~ ~ {auto:0b}");
                line = Regex.Replace(line, @"active:(@(e|p|r|a)(\[.*\])?)", "execute $1 ~ ~ ~ blockdata ~ ~ ~ {auto:1b}");
                line = Regex.Replace(line, @"close:(@(e|p|r|a)(\[.*\])?)", "execute $1 ~ ~ ~ blockdata ~ ~ ~ {auto:0b}");
                //new
